...
(function () {
  ...
  const ING = {
    ...
    honey: `
      <svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
        <rect x="20" y="26" width="40" height="42" rx="12" fill="#f2b730"/>
        <rect x="16" y="16" width="48" height="13" rx="6.5" fill="#d98324"/>
        <rect x="26" y="38" width="28" height="18" rx="5" fill="#fff6e0"/>
        <path d="M34,48 Q40,42 46,48" stroke="#d98324" stroke-width="3" fill="none" stroke-linecap="round"/>
      </svg>`,
    noodles: `
      <svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
        ${[0, 1, 2, 3, 4].map(i =>
          `<path d="M${18 + i * 9},20 Q${26 + i * 9},42 ${22 + i * 9},62" stroke="#f2d9a0" stroke-width="6" fill="none" stroke-linecap="round"/>`).join('')}
        <rect x="16" y="34" width="46" height="14" rx="4" fill="#ff9eb5"/>
        <circle cx="39" cy="41" r="4" fill="#fff"/>
      </svg>`,
    egg: `
      <svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
    ...
    scallion: `
      <svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
        <ellipse cx="40" cy="62" rx="10" ry="13" fill="#f2f7e8"/>
        <line x1="36" y1="54" x2="33" y2="22" stroke="#6cc46a" stroke-width="6" stroke-linecap="round"/>
        <line x1="44" y1="54" x2="47" y2="22" stroke="#6cc46a" stroke-width="6" stroke-linecap="round"/>
        <line x1="40" y1="52" x2="40" y2="16" stroke="#7ed47b" stroke-width="6" stroke-linecap="round"/>
        <path d="M36,74 L34,79 M44,74 L46,79" stroke="#d9e4c9" stroke-width="2.5" stroke-linecap="round"/>
      </svg>`,
    carrot: `
      <svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
    ...
    bokchoy: `
      <svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
        <ellipse cx="40" cy="60" rx="13" ry="15" fill="#f2f7e8"/>
        <ellipse cx="28" cy="54" rx="7" ry="14" fill="#e8f0dc" transform="rotate(-16 28 54)"/>
        <ellipse cx="52" cy="54" rx="7" ry="14" fill="#e8f0dc" transform="rotate(16 52 54)"/>
        <ellipse cx="40" cy="34" rx="17" ry="17" fill="#6cc46a"/>
        <ellipse cx="27" cy="40" rx="11" ry="14" fill="#7ed47b" transform="rotate(-28 27 40)"/>
        <ellipse cx="53" cy="40" rx="11" ry="14" fill="#7ed47b" transform="rotate(28 53 40)"/>
      </svg>`,
    flour: `
      <svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
        <path d="M22,26 L58,26 L62,68 Q40,74 18,68 Z" fill="#f2e0c8"/>
        <rect x="22" y="16" width="36" height="12" rx="4" fill="#e0cba8"/>
        <circle cx="40" cy="48" r="12" fill="#fff"/>
        <path d="M34,52 Q37,44 40,52 Q43,44 46,52" stroke="#d9a83e" stroke-width="2.6" fill="none" stroke-linecap="round"/>
      </svg>`,
    milk: `
      <svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
    ...
    sugar: `
      <svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
        <rect x="22" y="24" width="36" height="44" rx="10" fill="#fffdf5"/>
        <rect x="18" y="14" width="44" height="12" rx="6" fill="#c9d2da"/>
        <path d="M40,54 C34,54 32,48 36,45 C38,43.5 40,45 40,46 C40,45 42,43.5 44,45 C48,48 46,54 40,54 Z" fill="#ff9eb5"/>
      </svg>`,
    butter: `
      <svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
        <ellipse cx="40" cy="60" rx="26" ry="8" fill="#fff"/>
        <path d="M20,42 L48,42 L56,50 L28,50 Z" fill="#ffe9a8"/>
        <rect x="20" y="42" width="28" height="14" fill="#ffd166"/>
        <path d="M48,42 L56,50 L56,64 L48,56 Z" fill="#f2c94c"/>
        <rect x="20" y="56" width="28" height="14" fill="#ffd166"/>
        <path d="M48,56 L56,64 L28,64 L20,56 Z" fill="#ffe9a8"/>
      </svg>`,
    chocolate: `
      <svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
